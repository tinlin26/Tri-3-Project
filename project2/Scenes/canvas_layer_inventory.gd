...
@onready var lettuce_label = $InventoryPanel/InventoryBoxes3/Pie/PieCountLabel
...
func update_lettuce_count(new_count: int):
	lettuce_count = new_count
	lettuce_label.text = str(lettuce_count)
